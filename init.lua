...
require('packer').startup(function(use)
  ...
  use { -- LSP Conf/iguration & Plugins
  ...
  use 'dense-analysis/ale' -- code analysis
  use 'preservim/nerdtree'
  use 'prabirshrestha/asyncomplete.vim' -- code completion
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'go', 'css', 'html', 'markdown', 'regex', 'yaml', 'c_sharp', 'dart', 'dockerfile', 'graphql', 'javascript', 'json', 'lua', 'typescript', 'help' },
